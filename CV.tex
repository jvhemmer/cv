...
\begin{tabularx}{\textwidth}{>{\columncolor{lightblue}}p{1.8cm}X}  % Adjusted to remove padding
	\centering\textbf{2026} &
	Optical field-induced mass transfer in plasmonic electrochemistry\vspace{0.1cm}                                        \\
	                        & \textbf{Hemmer, J. V.}; Al-Amin, M.;  Wilson, A. J.                                          \\
	                        & \textit{Chemical Communications}                                                             \\
	                        & \href{https://pubs.rsc.org/en/content/articlelanding/2026/cc/d5cc06109a}{10.1039/D5CC06109A} \\
\end{tabularx}
...
\begin{tabularx}{\textwidth}{>{\columncolor{lightblue}}p{1.8cm}X}  % Adjusted to remove padding
	...
	Effect of Temperature Gradients on the Selectivity of the Electrocatalytic CO$_{2}$ Reduction Reaction \vspace{0.1cm}                                                                                                             \\
	                        & Al-Amin, M.; \textbf{Hemmer, J. V.}; Wilson, A. J.                                                                                                                                                      \\
	                        & \textit{ACS Applied Materials and Interfaces}                                                                                                                                                           \\
	                        & \href{https://pubs.acs.org/doi/10.1021/acsami.5c12578}{10.1021/acsami.5c12578}                                                                                                                          \\
\\
	\centering\textbf{}     &
